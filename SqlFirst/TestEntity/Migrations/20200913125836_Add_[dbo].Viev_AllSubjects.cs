...
{
    public partial class Add_dboViev_AllSubjects : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var spShowSomeStudents = "CREATE VIEW [dbo].Viev_AllSubjects " +
        ...
        {
            var spShowSomeStudents = "DROP VIEW [dbo].Viev_AllSubjects";
            migrationBuilder.Sql(spShowSomeStudents);
        }
    }
}
